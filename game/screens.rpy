            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %d de %B %Y, %H:%M"), empty=_("empty")):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("After elections") action Preference("after choices", "toggle")
...
screen history():
    ...
    use game_menu(_("Record"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0, spacing=gui.history_spacing):
    ...
    use game_menu(_("Help"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    textbutton _("Controller") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    hbox:
        label _("Intro")
        text _("The dialogue advances and the interface is activated.")

    hbox:
        label _("Space")
        text _("Advances dialogue without selecting options.")
    ...
    hbox:
        label _("Escape")
        text _("Access the main menu.")

    hbox:
        label _("Ctrl")
        text _("Skips dialogue while press")

    hbox:
        label _("Tab")
        text _("Activates/deactivates dialogue skipping.")

    hbox:
        label _("Adv. pag.")
        text _("Go back to the previous dialogue.")

    hbox:
        label _("Re. pag.")
        text _("Proceed to the next dialogue.")

    hbox:
        label "H"
        text _("Hides the interface.")
    ...
    hbox:
        label "V"
        text _("Activate/deactivate assistance by {a=https://www.renpy.org/l/voicing}voz-automática{/a}.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Left trigger\nLeft front top button")
        text _("Go back to the previous dialogue.")

    hbox:
        label _("upper front right button")
        text _("Proceed to the next dialogue.")
    ...
    hbox:
        label _("Home, Guide, B/Right Button")
        text _("Access the main menu.")
...
screen lago_main():
    ...
    #Opcion cielo
    imagebutton:
        idle "gui/lago/Imagenes/cielo_sprite.png"
        hover "gui/lago/Imagenes/cielo_sprite_hover.png"
        xpos 575
        ypos 109
        at transform:
            zoom 2.175
    ...
    #Opcion Barcaza
    imagebutton:
        idle "gui/lago/Imagenes/barco_sprite.png"
        hover "gui/lago/Imagenes/barco_sprite_hover.png"
        xpos 0
        ypos 788
        at transform:
            zoom 2.175
    ...
    #Puzle
    imagebutton:
        idle "gui/lago/Imagenes/lago_sprite.png"
        hover "gui/lago/Imagenes/lago_sprite_hover.png"
        xpos 783
        ypos 807
        at transform:
            zoom 2.18
...
init python:
    def reproducir_sonido(archivo):
        renpy.music.play(archivo, channel="sound")
...
screen orfanato_puzle_screen():
    ...
    frame:
        ...
        yalign 0.3
        vbox:
            text "What emotion does this view evoke on you?" size 20
    vbox:
        xalign 0.5
        yalign 0.55
        spacing 10
